Feature: Inventory
    ...
    # practicing-> find book -> delele book
...
# @demo @smoke @debug
#     Scenario Outline: <TestID>: Login and user want to find the book by > 5 items  DONE
#         # Given Login to inventory web app
#         Given As a standard user I login to demoqa web app
#         And User clicks on Book Store Application Button
#         Then Verify that the all the book shows in page
...
# @demo @smoke @debug
#     Scenario Outline: <TestID>: Login and user want to find the book then delete the book
#         # Given Login to inventory web app
#         Given As a standard user I login to demoqa web app
#         And User clicks on Book Store Application Button
#         Then Verify that the all the book shows in page
